...
sections.unshift([
  ...
  [
    [
      "Le parcours suit Importer, Assembler, Versions, Exporter puis Brand Guideline. Avant génération, six étapes préparent les polices, la palette finale distincte des couleurs de logo, les références Pantone facultatives, la couverture, jusqu’à trois mockups et les interdits. Chaque variante dispose de sa page de sécurité ; logos complets et éléments ont des pages de tailles minimales séparées. Les anciennes sauvegardes restent importables ; les nouvelles utilisent V5.",
      "The workflow follows Import, Assemble, Versions, Export, then Brand Guideline. Before generation, six steps prepare fonts, a final palette independent of logo colors, optional Pantone references, the cover, up to three mockups and logo misuses. Each variant has a clear-space page; full logos and elements have separate minimum-size pages. Older saves remain importable; new saves use V5.",
    ],
    [
    ...
    [
      "Les neuf pages de marque sont facultatives et conservent le contenu fourni. Un bouton permet d’insérer volontairement un texte fictif FR/EN dans une page vide. Les réglages se répartissent entre Réglages page et Réglages globaux. Les couleurs de mise en page proviennent de la palette finale. Les rôles typographiques affichent les tailles pt/px, l’interlignage, le tracking et la graisse du fichier importé. Instrument Sans reste disponible localement sous licence SIL OFL.",
      "The nine brand-content pages are optional and retain supplied copy. A button explicitly inserts fictional FR/EN copy into an empty page. Controls are organized under Page settings and Global settings. Layout colors come from the final palette. Type roles show pt/px sizes, line spacing, tracking and the imported file’s weight. Instrument Sans remains bundled locally under SIL OFL.",
    ],
    [
    ...
    [
      "Le bouton Assistant IA apparaît uniquement dans 05 Brand Guideline ; l’engrenage ouvre les fournisseurs et leurs modèles actualisables, avec catalogue de secours et ID personnalisé dans Avancé. OpenCode Go est disponible. Chaque modification devient une proposition temporaire, affinable par message, avec aperçu du guide lorsque disponible. Seul Appliquer modifie le projet et crée une entrée Undo. Une proposition devenue obsolète après une modification du projet doit être actualisée. Le test de connexion demande une réponse, un appel d’outil et l’envoi de son résultat. Les clés restent séparées du projet et ne sont mémorisées que sur demande. L’accès dépend du fournisseur, du modèle, du quota et des restrictions navigateur ; l’outil reste utilisable sans IA.",
      "The Assistant button appears only in 05 Brand Guideline; the gear opens providers and refreshable models, with fallback catalogs and custom IDs under Advanced. OpenCode Go is available. Every change becomes a temporary proposal, refinable by message, with a guide preview when available. Only Apply changes the project and creates an Undo entry. A proposal made stale by a project edit must be refreshed. The connection test requests a response, a tool call and submission of its result. Keys remain separate from the project and are remembered only on request. Access depends on the provider, model, quota and browser restrictions; the app remains usable without AI.",
    ],
  ],
]);
...
sections.push([
  ...
  [
    ...
    ["Dimensions supplémentaires ajoute un onglet JPEG depuis un preset ou un format nommé. Le cadrage est centré et proportionnel, propre au cas d’usage et à la variante ; toutes ses couleurs le partagent. La base standard reste 3000 × 3000 px.", "Additional dimensions adds a JPEG tab from a preset or named custom size. Framing is centered and proportional, specific to the use case and logo variant and shared by all its colors. The standard base remains 3000 × 3000 px."],
