    ...
    if (dialog.returnValue === "delete" && existing) {
      ...
      edit(() => {
        const next = {
          ...
          role: dialog.querySelector('[name="role"]').value,
        };
